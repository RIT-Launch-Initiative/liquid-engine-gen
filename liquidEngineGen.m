...
% 3 = Method of Characteristics [WORK IN PROGRESS]
...
INPUT.interiorContractionAngle = 45;                                       % [deg]
INPUT.exteriorContractionAngle = 45;                                       % [deg]

INPUT.chamberThickness_in = 0.15;                                          % [in]
INPUT.nozzleThickness_in = 0.0625;                                         % [in]
...
OUTPUT.dynamicViscosity               = OUTPUT.CEA.output.eql.viscosity;         % [cP] Dynamic Viscosity
...
[OUTPUT.interiorEngineContour, OUTPUT.exteriorEngineContour] = calcGeometry(OUTPUT.specificHeatRatio,OUTPUT.exitMachNumber,OUTPUT.chamberRadius,OUTPUT.exitRadius,OUTPUT.throatRadius, ...
